...
│   └── AGENTS.md           # API layer documentation
├── tools/                  # MCP tool registrations
│   └── AGENTS.md           # Tools layer documentation
├── toolception-adapters/   # Toolception framework integration
│   └── AGENTS.md           # Adapter layer documentation
├── server-mode-enforcer/   # Mode configuration singleton
│   └── AGENTS.md           # Mode enforcer documentation
├── constants/              # Tool sets and defaults
│   └── AGENTS.md           # Constants documentation
...
This codebase uses AGENTS.md files as an "Intent Layer" - structured documentation that helps AI agents understand and navigate the code efficiently.

### File Hierarchy

```
AGENTS.md (root)                           # Architecture, config, invariants
├── src/api/AGENTS.md                      # API clients and patterns
├── src/tools/AGENTS.md                    # Tool registration patterns
├── src/toolception-adapters/AGENTS.md     # Framework integration
...
Update the relevant AGENTS.md when:
...
6. **Link to child nodes** - Reference deeper AGENTS.md files with `→ path/AGENTS.md`
